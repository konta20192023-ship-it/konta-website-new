      ...
      <section className="py-24 bg-secondary">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { id: "01", title: "천연잔디 코스의 여유", desc: "전략적인 코스 구성과 완벽하게 관리된 천연잔디에서의 라운드" },
              { id: "02", title: "다양한 지형의 색다른 재미", desc: "사계절 내내 플레이가 가능한 흥미로운 지형과 코스" },
              { id: "03", title: "계절이 빚어낸 아름다움", desc: "일본의 자연 속에서 계절마다 다른 매력의 플레이 경험" },
              { id: "04", title: "온천 · 관광 · 미식", desc: "플레이 후 이어지는 고품격 온천 휴식과 도쿄 미식 탐방" },
              { id: "05", title: "편안하고 안전한 진행", desc: "전용차량과 한국인 가이드 동행으로 오직 여행에만 집중" },
            ].map((point, i) => (
              <motion.div
                key={point.id}
